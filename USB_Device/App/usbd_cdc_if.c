...
/**
  * @brief  Whether a previous CDC_Transmit_FS is still in flight (or the
  *         device is not configured). Callers check this before filling a
  *         TX buffer so an in-flight buffer is never overwritten.
  */
